...
public class ControladorMensajes {
   ...
   //Regresa informacion de la base de datos al destinatario 
    ...
    //Envia informcion del destinario a la base de datos 
    @RequestMapping(value="/mensajito/{id}/{titulo}/{cuerpo}"/*direccion de url*/, method=RequestMethod.GET,
            headers={"Accept=application/json"})
    public Estatus guardar(@PathVariable String id,@PathVariable String titulo,@PathVariable/*Variable de ruta*/ String cuerpo){
